...
public class WorldRenderer {
	 ...
	 */
	private static final float CAMERA_WIDTH = (32*10); //Ici on décide du nombre de tiles affichées à l'écran.
	private static final float CAMERA_HEIGHT = (32*7); //Dans ce cas, on affiche 10*7 tiles.
